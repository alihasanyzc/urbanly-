...
> yapay zekâ (AI) asistanlarının (Claude Code, Copilot vb.) kod üretirken uyması gereken
...
- Bu dosya (`CLAUDE.md`) proje kökünde tutulur ve AI asistanları tarafından **otomatik okunur**.
